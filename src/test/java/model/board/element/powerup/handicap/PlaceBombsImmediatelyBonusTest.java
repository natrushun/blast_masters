...
public class PlaceBombsImmediatelyBonusTest {

    Player player;
    PlaceBombsImmediatelyBonus placeBombsImmediatelyBonus;
    ...
    public void setUp() {
        ...
        placeBombsImmediatelyBonus = new PlaceBombsImmediatelyBonus(0,0,0,0,0,null,false,false,player);
    ...
    @Test
    public void useTest() {
        assertFalse(player.hasToPlaceBombsImmediately());

        placeBombsImmediatelyBonus.use();
        assertTrue(player.hasToPlaceBombsImmediately());
    }
