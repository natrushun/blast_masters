...
public class NoBombsBonusTest {

    Player player;
    NoBombsBonus noBombsBonus;
    ...
    public void setUp() {
        ...
        noBombsBonus = new NoBombsBonus(0,0,0,0,0,null,false,false,player);
    ...
    public void useTest() {
        noBombsBonus.use();
        assertEquals(false, player.getCanPlaceBombs());
