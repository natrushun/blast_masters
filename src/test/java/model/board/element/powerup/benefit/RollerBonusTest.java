...
public class RollerBonusTest {

    Player player;
    RollerBonus rollerBonus;
    ...
    public void setUp() {
        ...
        rollerBonus = new RollerBonus(0,0,0,0,0,null,false,false,player);
    ...
    @Test
    public void useTest() {
        double prevNumber = player.getVelocity();
        rollerBonus.use();
        assertEquals(prevNumber + 0.5, player.getVelocity(),0);
